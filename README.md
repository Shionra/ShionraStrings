...
Credit to credit nurver, realmadrid1809 and AnonymousPoke for the Unova Placeholder file that stops the strings from breaking the PokeMMO versions of strings with regular Bill's.
